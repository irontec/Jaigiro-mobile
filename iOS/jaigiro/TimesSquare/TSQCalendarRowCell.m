...
- (void)createDayButtons;
{
    ...
    for (NSUInteger index = 0; index < self.daysInWeek; index++) {
        ...
        [button setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];//Color de letra de cada dia del mes actual
        [button setBackgroundColor:[UIColor_Jaigiro getColor:0]];//Fondo de cada dia del mes actual
...
- (void)createNotThisMonthButtons;
{
    ...
    for (NSUInteger index = 0; index < self.daysInWeek; index++) {
        ...
        [button setTitleColor:[UIColor_Jaigiro getColor:1]  forState:UIControlStateNormal];//Color de letra de los dias de otro mes
        [button setBackgroundColor:[UIColor whiteColor]];//Fondo de cada dde los dias de otro mes
        //[button.titleLabel setTextColor:[UIColor blueColor]];
        [button.titleLabel setBackgroundColor:[UIColor clearColor]];//Color de fondo del label del dia de los dias de otro mes
    }
...
- (void)createTodayButton;
{
    ...
    [self.todayButton setBackgroundColor:[UIColor_Jaigiro getColor:2]];
...
/*
    ...
    NSDateComponents *dateComponents = [self.calendar components:unitFlags fromDate:self.calendarView.selectedDate];
    ...
    NSLog(@"Today day button: %d",[self.todayDateComponents day]);
    NSLog(@"Today month button: %d",[self.todayDateComponents month]);
*/
